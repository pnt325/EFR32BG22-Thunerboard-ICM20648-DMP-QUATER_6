...
* ________________________________________________________________________________________________________
*/
/** @defgroup	inv_icm20648_secondary_transport	inv_secondary_transport
    @ingroup 	SmartSensor_driver
    @{
*/
#ifndef INV_ICM20648_SECONDARY_TRANSPORT_H__
#define INV_ICM20648_SECONDARY_TRANSPORT_H__
...
/** @brief Restore secondary I2C ODR configured based on the one saved with inv_icm20648_secondary_saveI2cOdr()
*/
...
#endif // INV_ICM20648_SECONDARY_TRANSPORT_H__
