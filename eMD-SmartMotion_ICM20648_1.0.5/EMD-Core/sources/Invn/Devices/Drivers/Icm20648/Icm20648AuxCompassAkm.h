...
* ________________________________________________________________________________________________________
*/
/** @defgroup	inv_icm20648_slave_compass	inv_slave_compass
    @ingroup 	SmartSensor_driver
    @{
*/
#ifndef INV_ICM20648_SLAVE_COMPASS_H_SDFWQN__
#define INV_ICM20648_SLAVE_COMPASS_H_SDFWQN__
 ...
 */
enum inv_icm20648_compass_id {
	INV_ICM20648_COMPASS_ID_NONE = 0, /**< no compass */
 ...
 *  Must be called before inv_icm20648_initialize().
 *
 *  @param[in]  compass_id 	        Compass ID
 *  @param[in]  compass_i2c_addr 	Compass I2C address
 *  @return     0 on success, negative value on error
 */
void INV_EXPORT inv_icm20648_register_aux_compass(struct inv_icm20648 * s,
...
#endif // INV_ICM20648_SLAVE_COMPASS_H_SDFWQN__
