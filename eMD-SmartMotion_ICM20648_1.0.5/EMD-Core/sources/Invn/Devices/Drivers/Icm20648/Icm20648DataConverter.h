...
* ________________________________________________________________________________________________________
*/
/** @defgroup icm20648_data_converter data_converter
	@ingroup  SmartSensor_driver
	@{
*/	
#ifndef INV_ICM20648_DATA_CONVERTER_H__
#define INV_ICM20648_DATA_CONVERTER_H__
...
int INV_EXPORT inv_icm20648_convert_compute_scalar_part_fxp(const long * inQuat_q30, long* outQuat_q30);
 ...
 * \ingroup MatrixFxp
 */
void INV_EXPORT inv_icm20648_convert_quat_to_col_major_matrix_fxp(const long *quat_q30, long *rot_q30);
...
#endif
#endif	/* INV_ICM20648_DATA_CONVERTER_H__ */
