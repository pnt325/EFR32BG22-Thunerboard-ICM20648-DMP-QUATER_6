...
#include <ICM20648/Invn/Devices/Drivers/Icm20648/Icm20648Augmented.h>
#include <ICM20648/Invn/Devices/Drivers/Icm20648/Icm20648AuxCompassAkm.h>
#include <ICM20648/Invn/Devices/Drivers/Icm20648/Icm20648AuxTransport.h>
#include <ICM20648/Invn/Devices/Drivers/Icm20648/Icm20648DataBaseControl.h>
...
/*
   inv_icm20648_ctrl_get_odr(s)
   Function to Query DMP3 DataRate (ODR)

   *odr = inv_icm20648_get_odr_in_units( );

    The result in odr_units saved in *odr param
*/
int inv_icm20648_ctrl_get_odr(struct inv_icm20648 * s, unsigned char SensorId, uint32_t *odr, enum INV_ODR_TYPE odr_units)
{
	int result=0;
	...
	*odr = 0;
	...
	when calling inv_icm20648_get_odr_in_units().
	*/

	switch (SensorId) {
		case ANDROID_SENSOR_ACCELEROMETER:
		case ANDROID_SENSOR_RAW_ACCELEROMETER:
			*odr = inv_icm20648_get_odr_in_units(s, s->inv_dmp_odr_dividers[INV_SENSOR_ACCEL] , odr_units );
			break;

		case ANDROID_SENSOR_STEP_DETECTOR:
		case ANDROID_SENSOR_STEP_COUNTER:
			*odr = inv_icm20648_get_odr_in_units(s, s->inv_dmp_odr_dividers[INV_SENSOR_STEP_COUNTER] , odr_units );
			break;

		case ANDROID_SENSOR_GEOMAGNETIC_ROTATION_VECTOR:
			*odr = inv_icm20648_get_odr_in_units(s, s->inv_dmp_odr_dividers[INV_SENSOR_GEOMAG] , odr_units );
			break;

		case ANDROID_SENSOR_ACTIVITY_CLASSIFICATON:
			*odr = inv_icm20648_get_odr_in_units(s, s->inv_dmp_odr_dividers[INV_SENSOR_ACTIVITY_CLASSIFIER] , odr_units );
			break;

		case ANDROID_SENSOR_GYROSCOPE_UNCALIBRATED:
		case ANDROID_SENSOR_RAW_GYROSCOPE:
			*odr = inv_icm20648_get_odr_in_units(s, s->inv_dmp_odr_dividers[INV_SENSOR_GYRO] , odr_units );
			break;

		case ANDROID_SENSOR_GYROSCOPE:
			*odr = inv_icm20648_get_odr_in_units(s, s->inv_dmp_odr_dividers[INV_SENSOR_CALIB_GYRO] , odr_units );
			break;

		case ANDROID_SENSOR_GAME_ROTATION_VECTOR:
		case ANDROID_SENSOR_GRAVITY:
		case ANDROID_SENSOR_LINEAR_ACCELERATION:
			*odr = inv_icm20648_get_odr_in_units(s, s->inv_dmp_odr_dividers[INV_SENSOR_SIXQ] , odr_units );
			break;

		case ANDROID_SENSOR_ORIENTATION:
		case ANDROID_SENSOR_ROTATION_VECTOR:
			*odr = inv_icm20648_get_odr_in_units(s, s->inv_dmp_odr_dividers[INV_SENSOR_NINEQ] , odr_units );
			break;

		case ANDROID_SENSOR_MAGNETIC_FIELD_UNCALIBRATED:
			*odr = inv_icm20648_get_odr_in_units(s, s->inv_dmp_odr_dividers[INV_SENSOR_COMPASS] , odr_units );
			break;

		case ANDROID_SENSOR_GEOMAGNETIC_FIELD:
			*odr = inv_icm20648_get_odr_in_units(s, s->inv_dmp_odr_dividers[INV_SENSOR_CALIB_COMPASS] , odr_units );
			break;

		case ANDROID_SENSOR_LIGHT:
		case ANDROID_SENSOR_PROXIMITY:
			*odr = inv_icm20648_get_odr_in_units(s, s->inv_dmp_odr_dividers[INV_SENSOR_ALS] , odr_units );
			break;

		case ANDROID_SENSOR_WAKEUP_ACCELEROMETER:
			*odr = inv_icm20648_get_odr_in_units(s, s->inv_dmp_odr_dividers[INV_SENSOR_WAKEUP_ACCEL] , odr_units );
			break;

		case ANDROID_SENSOR_WAKEUP_STEP_DETECTOR:
		case ANDROID_SENSOR_WAKEUP_STEP_COUNTER:
		case ANDROID_SENSOR_WAKEUP_SIGNIFICANT_MOTION:
			*odr = inv_icm20648_get_odr_in_units(s, s->inv_dmp_odr_dividers[INV_SENSOR_WAKEUP_STEP_COUNTER] , odr_units );
			break;

		case ANDROID_SENSOR_WAKEUP_GEOMAGNETIC_ROTATION_VECTOR:
			*odr = inv_icm20648_get_odr_in_units(s, s->inv_dmp_odr_dividers[INV_SENSOR_WAKEUP_GEOMAG] , odr_units );
			break;

		case ANDROID_SENSOR_WAKEUP_TILT_DETECTOR:
			*odr = inv_icm20648_get_odr_in_units(s, s->inv_dmp_odr_dividers[INV_SENSOR_WAKEUP_TILT_DETECTOR] , odr_units );
			break;

		case ANDROID_SENSOR_B2S:
			*odr = inv_icm20648_get_odr_in_units(s, s->inv_dmp_odr_dividers[INV_SENSOR_BRING_TO_SEE] , odr_units );
			break;

		case ANDROID_SENSOR_WAKEUP_GYROSCOPE_UNCALIBRATED:
			*odr = inv_icm20648_get_odr_in_units(s, s->inv_dmp_odr_dividers[INV_SENSOR_WAKEUP_GYRO] , odr_units );
			break;

		case ANDROID_SENSOR_WAKEUP_GYROSCOPE:
			*odr = inv_icm20648_get_odr_in_units(s, s->inv_dmp_odr_dividers[INV_SENSOR_WAKEUP_CALIB_GYRO] , odr_units );
			break;

		case ANDROID_SENSOR_WAKEUP_GAME_ROTATION_VECTOR:
			*odr = inv_icm20648_get_odr_in_units(s, s->inv_dmp_odr_dividers[INV_SENSOR_WAKEUP_SIXQ] , odr_units );
			break;

		case ANDROID_SENSOR_WAKEUP_GRAVITY:
		case ANDROID_SENSOR_WAKEUP_LINEAR_ACCELERATION:
			*odr = inv_icm20648_get_odr_in_units(s, s->inv_dmp_odr_dividers[INV_SENSOR_WAKEUP_SIXQ_accel] , odr_units );
			break;

		case ANDROID_SENSOR_WAKEUP_ORIENTATION:
		case ANDROID_SENSOR_WAKEUP_ROTATION_VECTOR:
			*odr = inv_icm20648_get_odr_in_units(s, s->inv_dmp_odr_dividers[INV_SENSOR_WAKEUP_NINEQ] , odr_units );
			break;

		case ANDROID_SENSOR_WAKEUP_MAGNETIC_FIELD_UNCALIBRATED:
			*odr = inv_icm20648_get_odr_in_units(s, s->inv_dmp_odr_dividers[INV_SENSOR_WAKEUP_COMPASS] , odr_units );
			break;

		case ANDROID_SENSOR_WAKEUP_MAGNETIC_FIELD:
			*odr = inv_icm20648_get_odr_in_units(s, s->inv_dmp_odr_dividers[INV_SENSOR_WAKEUP_CALIB_COMPASS] , odr_units );
			break;

		case ANDROID_SENSOR_WAKEUP_LIGHT:
		case ANDROID_SENSOR_WAKEUP_PROXIMITY:
			*odr = inv_icm20648_get_odr_in_units(s, s->inv_dmp_odr_dividers[INV_SENSOR_WAKEUP_ALS] , odr_units );
			break;

		case ANDROID_SENSOR_PRESSURE:
			*odr = inv_icm20648_get_odr_in_units(s, s->inv_dmp_odr_dividers[INV_SENSOR_PRESSURE] , odr_units );
			break;

		case ANDROID_SENSOR_WAKEUP_PRESSURE:
			*odr = inv_icm20648_get_odr_in_units(s, s->inv_dmp_odr_dividers[INV_SENSOR_WAKEUP_PRESSURE] , odr_units );
			break;

		case ANDROID_SENSOR_FLIP_PICKUP:
			*odr = inv_icm20648_get_odr_in_units(s, s->inv_dmp_odr_dividers[INV_SENSOR_FLIP_PICKUP] , odr_units );
			break;
...
int inv_icm20648_ctrl_enable_batch(struct inv_icm20648 * s, unsigned char enable)
{
	int ret = 0;
	...
	ret = dmp_icm20648_set_data_output_control2(s, s->inv_sensor_control2);

	/* give batch mode status to mems transport layer
	to allow disable/enable LP_EN when reading FIFO in batch mode */
	inv_icm20648_ctrl_set_batch_mode_status(s, enable);

	return ret;
}

void inv_icm20648_ctrl_set_batch_mode_status(struct inv_icm20648 * s, unsigned char enable)
{
	if(enable)
		s->sBatchMode=1;
	else
...
int inv_icm20648_ctrl_set_batch_timeout(struct inv_icm20648 * s, unsigned short batch_time_in_seconds)
{
	...
	if(    s->inv_sensor_control & GYRO_CALIBR_SET
		...
		timeout = (unsigned int) (batch_time_in_seconds * (BASE_SAMPLE_RATE/ (inv_icm20648_get_gyro_divider(s) + 1)));
		return dmp_icm20648_set_batchmode_params(s, timeout, GYRO_AVAILABLE);
	}

	if(    s->inv_sensor_control & ACCEL_SET
		|| s->inv_sensor_control & GEOMAG_SET ) { // If Accel is enabled and no Gyro based sensor is enabled.
		timeout = (unsigned int) (batch_time_in_seconds * (BASE_SAMPLE_RATE/ (inv_icm20648_get_accel_divider(s) + 1)));
		return dmp_icm20648_set_batchmode_params(s, timeout, ACCEL_AVAILABLE);
	}
	...
	if(    s->inv_sensor_control & CPASS_SET
		...
		timeout = (unsigned int) (batch_time_in_seconds * (BASE_SAMPLE_RATE/ inv_icm20648_get_secondary_divider(s)));

		if(    s->inv_sensor_control & CPASS_SET
			|| s->inv_sensor_control & CPASS_CALIBR_SET ) {
			rc |= dmp_icm20648_set_batchmode_params(s, timeout, SECONDARY_COMPASS_AVAILABLE);
		}
...
int inv_icm20648_ctrl_set_batch_timeout_ms(struct inv_icm20648 * s, unsigned short batch_time_in_ms)
{
	unsigned int timeout = 0;
	...
	if(    s->inv_sensor_control & GYRO_CALIBR_SET
		...
		|| s->inv_sensor_control & QUAT9_SET
		|| s->inv_sensor_control & GYRO_SET ) { // If Gyro based sensor is enabled.
		timeout = (unsigned int) ((batch_time_in_ms * (BASE_SAMPLE_RATE/ (inv_icm20648_get_gyro_divider(s) + 1)))/1000);
	...
	if(    s->inv_sensor_control & ACCEL_SET
		|| s->inv_sensor_control & GEOMAG_SET ) { // If Accel is enabled and no Gyro based sensor is enabled.
		timeout = (unsigned int) ((batch_time_in_ms * (BASE_SAMPLE_RATE/ (inv_icm20648_get_accel_divider(s) + 1)))/1000);
	...
	if(    s->inv_sensor_control & CPASS_SET
		|| s->inv_sensor_control & CPASS_CALIBR_SET ) {
		timeout = (unsigned int) ((batch_time_in_ms * (BASE_SAMPLE_RATE/ inv_icm20648_get_secondary_divider(s)))/1000);
		if(batch_time_in_ms < s->inv_androidSensorsOdr_boundaries[ANDROID_SENSOR_GEOMAGNETIC_FIELD][0]) {
			return -1; // requested batch timeout is not supported
		} else {
			return dmp_icm20648_set_batchmode_params(s, timeout, SECONDARY_COMPASS_AVAILABLE);
		}
	}
...
*/
unsigned long *inv_icm20648_ctrl_get_androidSensorsOn_mask(struct inv_icm20648 * s)
{
 ...
 */
int inv_icm20648_ctrl_enable_pickup(struct inv_icm20648 * s, unsigned char enable)
{
	s->pickup = enable;
	if(enable)
	...
	return dmp_icm20648_set_data_output_control2(s, s->inv_sensor_control2);
}

int inv_icm20648_ctrl_get_acc_bias(struct inv_icm20648 * s, int * acc_bias)
{
	return dmp_icm20648_get_bias_acc(s, acc_bias);
}
...
int inv_icm20648_ctrl_set_acc_bias(struct inv_icm20648 * s, int * acc_bias)
{
	...
	rc = dmp_icm20648_set_bias_acc(s, &s->bias[0]);
...
int inv_icm20648_ctrl_set_gyr_bias(struct inv_icm20648 * s, int * gyr_bias)
{
	...
	rc = dmp_icm20648_set_bias_gyr(s, &s->bias[3]);

	return rc;
}

int inv_icm20648_ctrl_set_mag_bias(struct inv_icm20648 * s, int * mag_bias)
{
	int rc = 0;
