...
/** @defgroup DriverIcm20648 Icm20648 driver
 *  @brief    Low-level driver for ICM20648 devices
 *  @ingroup  Drivers
 *  @{
 */

#ifndef _INV_ICM20648_H_
#define _INV_ICM20648_H_
...
#include <ICM20648/Invn/Devices/Drivers/Icm20648/Icm20648SelfTest.h>
#include <ICM20648/Invn/Devices/Drivers/Icm20648/Icm20648Serif.h>
#include <ICM20648/Invn/Devices/Drivers/Icm20648/Icm20648Setup.h>
#include <ICM20648/Invn/Devices/Drivers/Icm20648/Icm20648Transport.h>
#include <ICM20648/Invn/EmbUtils/InvBool.h>
#include <ICM20648/Invn/EmbUtils/InvError.h>
 ...
 */
typedef enum inv_icm20648_compass_state
{
	INV_ICM20648_COMPASS_RESET = 0,
	INV_ICM20648_COMPASS_INITED,
	INV_ICM20648_COMPASS_SETUP,
}inv_icm20648_compass_state_t;

/** @brief ICM20648 driver states definition
 */
typedef struct sensor_type_icm20648{
	uint64_t odr_applied_us;
	uint64_t odr_us;
}sensor_type_icm20648_t;

typedef enum {
	CHIP_LOW_NOISE_ICM20648,
	CHIP_LOW_POWER_ICM20648,
}chip_lp_ln_mode_icm20648_t;

typedef struct inv_icm20648 {
	struct inv_icm20648_serif serif;
	/** @brief struct for the base_driver : this contains the Mems information */
	struct base_driver_t
	{
		unsigned char wake_state;
		chip_lp_ln_mode_icm20648_t chip_lp_ln_mode;
	...
	struct inv_icm20648_secondary_states {
		...
		inv_icm20648_compass_state_t compass_state;
	} secondary_state;
	/* self test */
	...
	uint8_t skip_sample[INV_ICM20648_SENSOR_MAX+1];
	uint64_t timestamp[INV_ICM20648_SENSOR_MAX+1];
	uint8_t sFirstBatch[INV_ICM20648_SENSOR_MAX+1];
	sensor_type_icm20648_t sensorlist[INV_ICM20648_SENSOR_MAX+1];
...
/** @brief ICM20648 driver states singleton declaration
 *  Because of Low-level driver limitation only one insance of the driver is allowed
 */
extern struct inv_icm20648 * icm20648_instance;
