...
#include <ICM20648/Invn/Devices/Drivers/Icm20648/Icm20648.h>
#include <ICM20648/Invn/Devices/Drivers/Icm20648/Icm20648Defs.h>
#include <ICM20648/Invn/Devices/Drivers/Icm20648/Icm20648Dmp3Driver.h>
#include <ICM20648/Invn/Devices/Drivers/Icm20648/Icm20648LoadFirmware.h>
...
*/
int dmp_icm20648_set_batchmode_params(struct inv_icm20648 * s, unsigned int thld, short mask)
{
	int result;
	unsigned char big8[4]={0};
	unsigned char data[2]={0};

	result = inv_icm20648_write_mems(s, BM_BATCH_CNTR, 4, big8);
	result += inv_icm20648_write_mems(s, BM_BATCH_THLD, 4, inv_icm20648_convert_int32_to_big8(thld,big8));
	result += inv_icm20648_write_mems(s, BM_BATCH_MASK, 2, inv_icm20648_convert_int16_to_big8(mask,data));
...
*	[2] accel_z
*/
int dmp_icm20648_set_bias_acc(struct inv_icm20648 * s, int *bias)
{
	int result;
	unsigned char big8[4]={0};

	result = inv_icm20648_write_mems(s, ACCEL_BIAS_X, 4, inv_icm20648_convert_int32_to_big8(bias[0], big8));
	result += inv_icm20648_write_mems(s, ACCEL_BIAS_Y, 4, inv_icm20648_convert_int32_to_big8(bias[1], big8));
	result += inv_icm20648_write_mems(s, ACCEL_BIAS_Z, 4, inv_icm20648_convert_int32_to_big8(bias[2], big8));
...
*	[2] gyro_z
*/
int dmp_icm20648_set_bias_gyr(struct inv_icm20648 * s, int *bias)
{
	int result;
	unsigned char big8[4]={0};

	result = inv_icm20648_write_mems(s, GYRO_BIAS_X, 4, inv_icm20648_convert_int32_to_big8(bias[0], big8));
	result += inv_icm20648_write_mems(s, GYRO_BIAS_Y, 4, inv_icm20648_convert_int32_to_big8(bias[1], big8));
	result += inv_icm20648_write_mems(s, GYRO_BIAS_Z, 4, inv_icm20648_convert_int32_to_big8(bias[2], big8));
...
*	[2] compass_z
*/
int dmp_icm20648_set_bias_cmp(struct inv_icm20648 * s, int *bias)
{
	int result;
	unsigned char big8[4]={0};

	result = inv_icm20648_write_mems(s, CPASS_BIAS_X, 4, inv_icm20648_convert_int32_to_big8(bias[0], big8));
	result += inv_icm20648_write_mems(s, CPASS_BIAS_Y, 4, inv_icm20648_convert_int32_to_big8(bias[1], big8));
	result += inv_icm20648_write_mems(s, CPASS_BIAS_Z, 4, inv_icm20648_convert_int32_to_big8(bias[2], big8));
...
*	[2] accel_z
*/
int dmp_icm20648_get_bias_acc(struct inv_icm20648 * s, int *bias)
{
	int result;
	unsigned char big8[4]={0};

	result = inv_icm20648_read_mems(s, ACCEL_BIAS_X, 4, big8);
	bias[0] = inv_icm20648_convert_big8_to_int32(big8);
	result += inv_icm20648_read_mems(s, ACCEL_BIAS_Y, 4, big8);
	bias[1] = inv_icm20648_convert_big8_to_int32(big8);
	result += inv_icm20648_read_mems(s, ACCEL_BIAS_Z, 4, big8);
...
*	[2] gyro_z
*/
int dmp_icm20648_get_bias_gyr(struct inv_icm20648 * s, int *bias)
{
	int result;
	unsigned char big8[4]={0};

	result = inv_icm20648_read_mems(s, GYRO_BIAS_X, 4, big8);
	bias[0] = inv_icm20648_convert_big8_to_int32(big8);
	result += inv_icm20648_read_mems(s, GYRO_BIAS_Y, 4, big8);
	bias[1] = inv_icm20648_convert_big8_to_int32(big8);
	result += inv_icm20648_read_mems(s, GYRO_BIAS_Z, 4, big8);
	bias[2] = inv_icm20648_convert_big8_to_int32(big8);
...
*/
int dmp_icm20648_set_compass_cal_params(struct inv_icm20648 * s, int *compass_cal)
{
	int result;
	unsigned char big8[4]={0};

	result = inv_icm20648_write_mems(s, CPASS_TIME_BUFFER, 2, inv_icm20648_convert_int16_to_big8(compass_cal[CPASS_CAL_TIME_BUFFER], big8));
	result += inv_icm20648_write_mems(s, CPASS_RADIUS_3D_THRESH_ANOMALY, 4, inv_icm20648_convert_int32_to_big8(compass_cal[CPASS_CAL_RADIUS_3D_THRESH_ANOMALY], big8));
...
*/
int dmp_icm20648_set_pedometer_rate(struct inv_icm20648 * s, int ped_rate)
{
	// int result; 
	// unsigned char big8[4]={0};
	// result = inv_icm20648_write_mems(s, PED_RATE, 4, inv_icm20648_convert_int32_to_big8(ped_rate, big8));
	// if (result)
	//    return result;
...
*/
int dmp_icm20648_set_wom_enable(struct inv_icm20648 * s, unsigned char enable)
{
	int result;
	unsigned char big8[2]={0};
	...
	result = inv_icm20648_write_mems(s, WOM_ENABLE, 2, big8);
...
* @param[in] threshold
*/
int dmp_icm20648_set_wom_motion_threshold(struct inv_icm20648 * s, int threshold)
{
	int result;
	unsigned char big8[4]={0};

	result = inv_icm20648_write_mems(s, WOM_THRESHOLD, 4, inv_icm20648_convert_int32_to_big8(threshold, big8));
...
* @param[in] threshold
*/
int dmp_icm20648_set_wom_time_threshold(struct inv_icm20648 * s, unsigned short threshold)
{
	int result;
	unsigned char big8[2]={0};

	result = inv_icm20648_write_mems(s, WOM_CNTR_TH, 2, inv_icm20648_convert_int16_to_big8(threshold, big8));
...
*/
int dmp_icm20648_set_eis_auth_input(struct inv_icm20648 * s, long eis_auth_input)
{
	int result;
	unsigned char big8[4];

	result = inv_icm20648_write_mems(s, EIS_AUTH_INPUT, 4, inv_icm20648_convert_int32_to_big8(eis_auth_input, big8));
...
*/
int dmp_icm20648_get_eis_auth_output(struct inv_icm20648 * s, long *eis_auth_output)
{
	int result;
	unsigned char big8[4];

	result = inv_icm20648_read_mems(s, EIS_AUTH_OUTPUT, 4, big8);

	*eis_auth_output = inv_icm20648_convert_big8_to_int32(big8);
...
* @param[in] bac_odr. the values are 56 , 112 , 225 450 or 900 Hz
*/
int dmp_icm20648_set_fp_rate(struct inv_icm20648 * s, short accel_odr)
{
	unsigned char reg[4]={0,0,0,0};
	int result;
	long odr;
	...
	result = inv_icm20648_write_mems(s, FP_RATE, 4, inv_icm20648_convert_int32_to_big8(odr,reg));
	if (result) {
		return result;
	} else {
		return 0;
...
*/
int dmp_icm20648_reset_bac_states(struct inv_icm20648 * s)
{
	int result;
	...
	result = inv_icm20648_write_mems(s, BAC_STATE,             4, inv_icm20648_convert_int32_to_big8(reset, big8));
	result += inv_icm20648_write_mems(s, BAC_STATE_PREV,       4, inv_icm20648_convert_int32_to_big8(reset, big8));
	result += inv_icm20648_write_mems(s, BAC_ACT_ON,           4, inv_icm20648_convert_int32_to_big8(reset, big8));
	result += inv_icm20648_write_mems(s, BAC_ACT_OFF,          4, inv_icm20648_convert_int32_to_big8(reset, big8));
	result += inv_icm20648_write_mems(s, BAC_STILL_S_F,        4, inv_icm20648_convert_int32_to_big8(reset, big8));
	result += inv_icm20648_write_mems(s, BAC_RUN_S_F,          4, inv_icm20648_convert_int32_to_big8(reset, big8));
	result += inv_icm20648_write_mems(s, BAC_DRIVE_S_F,        4, inv_icm20648_convert_int32_to_big8(reset, big8));
	result += inv_icm20648_write_mems(s, BAC_WALK_S_F,         4, inv_icm20648_convert_int32_to_big8(reset, big8));
	result += inv_icm20648_write_mems(s, BAC_SMD_S_F,          4, inv_icm20648_convert_int32_to_big8(reset, big8));
	result += inv_icm20648_write_mems(s, BAC_BIKE_S_F,         4, inv_icm20648_convert_int32_to_big8(reset, big8));
	result += inv_icm20648_write_mems(s, BAC_E1_SHORT,         4, inv_icm20648_convert_int32_to_big8(reset, big8));
	result += inv_icm20648_write_mems(s, BAC_E2_SHORT,         4, inv_icm20648_convert_int32_to_big8(reset, big8));
	result += inv_icm20648_write_mems(s, BAC_E3_SHORT,         4, inv_icm20648_convert_int32_to_big8(reset, big8));
	result += inv_icm20648_write_mems(s, BAC_VAR_RUN,          4, inv_icm20648_convert_int32_to_big8(reset, big8));
	result += inv_icm20648_write_mems(s, BAC_DRIVE_CONFIDENCE, 4, inv_icm20648_convert_int32_to_big8(reset, big8));
	result += inv_icm20648_write_mems(s, BAC_WALK_CONFIDENCE,  4, inv_icm20648_convert_int32_to_big8(reset, big8));
	result += inv_icm20648_write_mems(s, BAC_SMD_CONFIDENCE,   4, inv_icm20648_convert_int32_to_big8(reset, big8));
	result += inv_icm20648_write_mems(s, BAC_BIKE_CONFIDENCE,  4, inv_icm20648_convert_int32_to_big8(reset, big8));
	result += inv_icm20648_write_mems(s, BAC_STILL_CONFIDENCE, 4, inv_icm20648_convert_int32_to_big8(reset, big8));
	result += inv_icm20648_write_mems(s, BAC_RUN_CONFIDENCE,   4, inv_icm20648_convert_int32_to_big8(reset, big8));
	result += inv_icm20648_write_mems(s, BAC_MODE_CNTR,        4, inv_icm20648_convert_int32_to_big8(reset, big8));
	result += inv_icm20648_write_mems(s, BAC_STATE_T_PREV,     4, inv_icm20648_convert_int32_to_big8(reset, big8));
	result += inv_icm20648_write_mems(s, BAC_ACT_T_ON,         4, inv_icm20648_convert_int32_to_big8(reset, big8));
	result += inv_icm20648_write_mems(s, BAC_ACT_T_OFF,        4, inv_icm20648_convert_int32_to_big8(reset, big8));
	result += inv_icm20648_write_mems(s, BAC_STATE_WRDBS_PREV, 4, inv_icm20648_convert_int32_to_big8(reset, big8));
	result += inv_icm20648_write_mems(s, BAC_ACT_WRDBS_ON,     4, inv_icm20648_convert_int32_to_big8(reset, big8));
	result += inv_icm20648_write_mems(s, BAC_ACT_WRDBS_OFF,    4, inv_icm20648_convert_int32_to_big8(reset, big8));
	result += inv_icm20648_write_mems(s, BAC_ACT_ON_OFF,       2, inv_icm20648_convert_int16_to_big8(reset_s, big8_s));
	result += inv_icm20648_write_mems(s, PREV_BAC_ACT_ON_OFF,  2, inv_icm20648_convert_int16_to_big8(reset_s, big8_s));
	result += inv_icm20648_write_mems(s, BAC_CNTR,             2, inv_icm20648_convert_int16_to_big8(reset_s, big8_s));
