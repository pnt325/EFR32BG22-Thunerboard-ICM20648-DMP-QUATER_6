...
* ________________________________________________________________________________________________________
*/
/** @defgroup icm20648_base_driver base_driver
	@ingroup  SmartSensor_driver
	@{
*/	
#ifndef INV_ICM20648_BASE_DRIVER_H__HWDFWQ__
#define INV_ICM20648_BASE_DRIVER_H__HWDFWQ__
...
*/
int INV_EXPORT inv_icm20648_initialize_lower_driver(struct inv_icm20648 * s, enum SMARTSENSOR_SERIAL_INTERFACE type, 
...
*/
uint32_t INV_EXPORT inv_icm20648_get_odr_in_units(struct inv_icm20648 * s, unsigned short odrInDivider, unsigned char odr_units );
...
#endif
#endif // INV_ICM20648_BASE_DRIVER_H__HWDFWQ__
