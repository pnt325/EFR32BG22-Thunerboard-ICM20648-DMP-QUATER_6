...
#include <ICM20648/Invn/Devices/Drivers/Icm20648/Icm20648DataConverter.h>
#include <string.h>
#include <math.h>
...
*/
void inv_icm20648_convert_rotation_vector_2(struct inv_icm20648 * s, const long *quat, long *quat4_world)
{
    long quat4[4];
    long quat_body_to_world[4];
...
*/
void inv_icm20648_convert_rotation_vector_3(const long *quat4_world, float *values)
{
    if (quat4_world[0] >= 0) {
...
unsigned char *inv_icm20648_int32_to_little8(long x, unsigned char *little8)
{
...
float inv_icm20648_convert_deg_to_rad(float deg_val)
{
	float rad_val;
...
void inv_icm20648_convert_matrix_to_quat_fxp(long *Rcb_q30, long *Qcb_q30)
{
         ...
         //Qcb[2] = sqrt(Qcb[2]);
         //Qcb[3] = sqrt(Qcb[3]);
         Qcb_q30[0] = inv_icm20648_convert_sqrt_q30_fxp(Qcb_q30[0]);
         Qcb_q30[1] = inv_icm20648_convert_sqrt_q30_fxp(Qcb_q30[1]);
         Qcb_q30[2] = inv_icm20648_convert_sqrt_q30_fxp(Qcb_q30[2]);
         Qcb_q30[3] = inv_icm20648_convert_sqrt_q30_fxp(Qcb_q30[3]);

         if(Qcb_q30[0] >= Qcb_q30[1] && Qcb_q30[0] >= Qcb_q30[2] && Qcb_q30[0] >= Qcb_q30[3]) //Qcb[0] is max
         {
                tmp = inv_icm20648_convert_inverse_q30_fxp(Qcb_q30[0], &pow2);
                shift = 30 - pow2 + 1;
         ...
         {
                tmp = inv_icm20648_convert_inverse_q30_fxp(Qcb_q30[1], &pow2);
                shift = 30 - pow2 + 1;
         ...
         {
                tmp = inv_icm20648_convert_inverse_q30_fxp(Qcb_q30[2], &pow2);
                shift = 30 - pow2 + 1;
         ...
         {
                tmp = inv_icm20648_convert_inverse_q30_fxp(Qcb_q30[3], &pow2);
                shift = 30 - pow2 + 1;
        ...
        // Normalize
        Qcb_q30[0] = inv_icm20648_convert_mult_q30_fxp(temp[0], Qcb_q30[0]);
        Qcb_q30[1] = inv_icm20648_convert_mult_q30_fxp(temp[0], Qcb_q30[1]);
        Qcb_q30[2] = inv_icm20648_convert_mult_q30_fxp(temp[0], Qcb_q30[2]);
        Qcb_q30[3] = inv_icm20648_convert_mult_q30_fxp(temp[0], Qcb_q30[3]);
}

long inv_icm20648_convert_sqrt_q30_fxp(long x_q30)
{
    long sqrtx;
    int pow2;
    ...
    sqrtx = inv_icm20648_convert_inv_sqrt_q30_fxp(x_q30, &pow2); // invsqrtx

    sqrtx = inv_icm20648_convert_mult_q30_fxp(x_q30, sqrtx);
...
long inv_icm20648_convert_inv_sqrt_q30_fxp(long x_q30, int *pow2)
{
...
upscale:
    ...
    x0_2 = xx >>1;
    xx = oneandhalf - x0_2;
    xx = inv_icm20648_convert_mult_q30_fxp( xx, ( oneandhalf - inv_icm20648_convert_mult_q30_fxp(x0_2, inv_icm20648_convert_mult_q30_fxp(xx,xx) ) ) );
    xx = inv_icm20648_convert_mult_q30_fxp( xx, ( oneandhalf - inv_icm20648_convert_mult_q30_fxp(x0_2, inv_icm20648_convert_mult_q30_fxp(xx,xx) ) ) );

    if (*pow2 & 1) { // This checks if the number is even or odd.
        *pow2 = (*pow2>>1) + 1; // Account for sqrt(2) in denominator
        invsqrtx = (inv_icm20648_convert_mult_q30_fxp(xx,oneoversqrt2));
    }
    else {
        *pow2 = *pow2>>1;
        invsqrtx =  xx;
...
long inv_icm20648_convert_inverse_q30_fxp(long x_q30, int *pow2)
{
    long y;
    int negx;
    ...
    y = inv_icm20648_convert_inv_sqrt_q30_fxp (x_q30, pow2); // sqrt(y)
    if (y > 1518500249L) // y > int32(sqrt(2) -1 : Largest number that won't overflow q30 multiplication of y*y
        y = INT32_MAX;
    else
        y = inv_icm20648_convert_mult_q30_fxp(y, y);
