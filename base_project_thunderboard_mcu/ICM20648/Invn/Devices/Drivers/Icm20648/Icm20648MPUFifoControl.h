...
* ________________________________________________________________________________________________________
*/
/** @defgroup inv_icm20648_mpu_fifo_control inv_mpu_fifo_control
	@ingroup  SmartSensor_driver
	@{
*/	
#ifndef INV_ICM20648_MPU_FIFO_CONTROL_H__GQWDHE__
#define INV_ICM20648_MPU_FIFO_CONTROL_H__GQWDHE__
...
* @return 				0 on success, negative value on error.
*/	
int INV_EXPORT inv_icm20648_dmp_process_fifo(struct inv_icm20648 * s, int *left_in_fifo, unsigned short *user_header, unsigned short *user_header2, long *time_stamp);
...
* @return 				0 on success, negative value on error.
*/	
int INV_EXPORT inv_icm20648_dmp_get_gmrvquaternion(long quat[3]);
...
*/	
int INV_EXPORT inv_icm20648_get_gmrv_accuracy(void);
...
#endif
#endif // INV_ICM20648_MPU_FIFO_CONTROL_H__GQWDHE__
